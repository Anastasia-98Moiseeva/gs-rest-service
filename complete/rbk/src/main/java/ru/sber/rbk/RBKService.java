...
import ru.sber.rbk.dataBase.DollarRate;
import ru.sber.rbk.dataBase.DollarRateCrudRepository;
...
public class RBKService {
    ...
    public static void main(String[] args) {
        SpringApplication.run(RBKService.class, args);
    }
    ...
    @Resource
    public DollarRateCrudRepository dollarRateCrudRepository;
